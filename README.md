# [gulp](https://github.com/gulpjs/gulp)-useref-assets

[![NPM](https://nodei.co/npm/gulp-useref-assets.png?downloads=true)](https://nodei.co/npm/gulp-useref-assets/)
...
Exactly the same as [gulp-useref](https://github.com/jonkemp/gulp-useref) but allows you to suppress the generation of output HTML files (default).
...
Skip create HTML files (new option).
